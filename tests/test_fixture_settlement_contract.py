...
class FixtureSettlementContractTests(unittest.TestCase):
    ...
    def test_shared_lock_has_priority_aware_settlement_handoff(self) -> None:
        ...
        self.assertIn("export ODDS_SYNC_LOCK_FD=9", source)
        self.assertIn("export ODDS_SYNC_JOB_PRIORITY", source)
        self.assertIn("settlement-priority", source)
        ...
        self.assertIn("status} -eq 75", source)
