...
# The Fixtures UI can request the full 14-day display window from any date;
# publish a 31-day source window so the calendar boundary is always covered
# and newly scheduled fixtures cannot sit outside the read model.
export FIXTURE_DELIVERY_DAYS_FORWARD="${FIXTURE_DELIVERY_DAYS_FORWARD:-31}"
